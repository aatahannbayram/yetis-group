...
export const IMAGE_MANIFEST: Record<ImageSlotId, ImageAsset> = {
  ...
  "process-tedarik": {
    id: "process-tedarik",
    src: "/scenes/process-tedarik-2.jpg",
    alt: "Olgunlaştırma mahzeninde peynir tekerleri",
    topic: "Süreç: tedarik",
  ...
  "process-siparis": {
    id: "process-siparis",
    src: "/scenes/process-siparis-2.jpg",
    alt: "Tablet üzerinde fiyat listesi, yanında peynir stoku",
    topic: "Süreç: sipariş",
  ...
  "process-sevkiyat": {
    id: "process-sevkiyat",
    src: "/scenes/process-sevkiyat-2.jpg",
    alt: "Soğuk zincir teslimatı, peynir sandıkları",
  ...
  "news-hero": {
    ...
    topic: "Haberler hero: peynir still life",
    usedAt: "news.hero",
    aspect: "16/9",
