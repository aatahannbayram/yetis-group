...
export default async function AdminAnalyticsPage() {
  ...
  const dealerMix = [
    { key: "active", label: "Aktif / onaylı", count: snap.dealers.active, color: "#00693e" },
    { key: "basvuru", label: "Başvuru", count: snap.dealers.basvuru, color: "#30a369" },
    { key: "inceleme", label: "İnceleme", count: snap.dealers.inceleme, color: "#a3edc3" },
    { key: "other", label: "Risk / pasif", count: snap.dealers.other, color: "#c4bdb0" },
  ];
  ...
  return (
    <div className="mx-auto max-w-6xl">
      ...
      <p className="mt-6 text-caption text-muted-foreground">
        Güncellendi · {formatDate(new Date())} · Sipariş / cari katmanı M4-M7 sonrası
      </p>
    </div>
  );
}
